...
**Expected counts at `f2f4099`** (from PR bodies): solver 104, web unit 344, integration 74. After PR1: solver 117, web unit 522 (33 files). After PR4 (stacked on PR3): solver 144, web unit 705 (44 files, incl. tenant isolation); with the PR4 review fixes web unit 732.
