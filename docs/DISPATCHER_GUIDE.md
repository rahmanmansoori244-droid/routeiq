...
- A trip whose driver a re-plan or **Use instead** changed is listed in yellow on the plan, for example *Driver changed by this plan: T02 · L1 (10:00–12:00) Ali → Sam, because Ali is on T03 · L1 at that time*, until you pick a driver for that trip; **Use instead** also says how many trips have another driver. Check the drivers after every re-plan.
